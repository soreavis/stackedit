...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders via **[GitHub Security Advisories](https://github.com/soreavis/stackedit/security/advisories/new)** (for anything requiring privacy) or by opening an issue tagged `conduct` for non-sensitive matters.
