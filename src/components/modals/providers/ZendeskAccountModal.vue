  ...
  <modal-inner aria-label="Link Zendesk account">
    <div class="modal__content">
      ...
      <form-entry label="Site URL" error="siteUrl">
        <template #field><input class="textfield" type="text" v-model.trim="siteUrl" @keydown.enter="resolve()"></template>
        <div class="form-entry__info">
          <b>Example:</b> https://example.zendesk.com/
        </div>
      </form-entry>
      <form-entry label="Client Unique Identifier" error="clientId">
        <template #field><input class="textfield" type="text" v-model.trim="clientId" @keydown.enter="resolve()"></template>
        <div class="form-entry__info">
