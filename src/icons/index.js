...
Vue.component('iconMath', Math_);
Vue.component('iconSitemap', Sitemap);
Vue.component('iconHorizontalRule', HorizontalRule);
Vue.component('iconMarker', Marker);
Vue.component('iconFootnote', Footnote);
Vue.component('iconFormatSubscript', FormatSubscript);
Vue.component('iconFormatSuperscript', FormatSuperscript);
Vue.component('iconCodeInline', CodeInline);
Vue.component('iconMusicNote', MusicNote);
Vue.component('iconAutoFix', AutoFix);
Vue.component('iconCalendar', Calendar);
Vue.component('iconCaseSensitiveAlt', CaseSensitiveAlt);
Vue.component('iconSortAlphabetical', SortAlphabetical);
Vue.component('iconOmega', Omega);
Vue.component('iconLinkBracket', LinkBracket);
Vue.component('iconLinkPaste', LinkPaste);
Vue.component('iconFrontmatter', Frontmatter);
